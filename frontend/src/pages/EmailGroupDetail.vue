...
const breadcrumbs = computed(() => {
  ...
  items.push({
    label: title.value,
    route: { name: 'EmailGroupDetail', params: { emailGroupId: props.emailGroupId } },
  })
  return items
})
...
const title = computed(() => {
  ...
  return doc?.[t] || props.emailGroupId
})
        ...
        sections: [{
          columns: [{
            fields: [
              ...
              { fieldname: 'total_subscribers', label: 'Total Subscribers', fieldtype: 'Int' },
              { fieldname: 'confirmation_email_template', label: 'Confirmation Email Template', fieldtype: 'Link', options: 'Email Template' },
              { fieldname: 'welcome_email_template', label: 'Welcome Email Template', fieldtype: 'Link', options: 'Email Template' },
              { fieldname: 'welcome_url', label: 'Welcome URL', fieldtype: 'Data' },
              { fieldname: 'add_query_parameters', label: 'Add Query Parameters', fieldtype: 'Check' }
            ]
          }]
        }]
      }]
