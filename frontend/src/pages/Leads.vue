<template>
  <AppStyling type="page-background" pageType="leads">
    <LayoutHeader>
...
// Add body class when Leads page is active
onMounted(() => {
  document.body.classList.add('leads-route')
})

onUnmounted(() => {
  document.body.classList.remove('leads-route')
})
