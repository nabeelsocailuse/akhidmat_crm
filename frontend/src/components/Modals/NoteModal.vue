    ...
    actions: [
      {
        ...
        variant: 'solid',
        onClick: () => updateNote(),
        class: editMode ? '' : '!bg-[#7c3aed] hover:!bg-[#6d28d9] !border-[#7c3aed] hover:!border-[#6d28d9] !text-white !font-bold !rounded-lg !px-4 !py-2 !shadow-lg hover:!shadow-xl hover:!-translate-y-0.5 !transition-all !duration-200',
      },
    ],
  }">
    <template #body-title>
