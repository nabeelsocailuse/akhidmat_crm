<template>
  <div class="flex items-center">
    <router-link
      :to="{ name: 'Donations' }"
      class="px-0.5 py-1 text-lg font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-outline-gray-3 text-ink-gray-7 hover:text-ink-gray-9"
    >
      {{ __(routeName) }}
    </router-link>
    <span
    ...
    <Dropdown v-if="viewControls && viewControls.viewsDropdownOptions" :options="viewControls.viewsDropdownOptions">
...
// Add safety checks for route properties
const safeRouteName = computed(() => {
