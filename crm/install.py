...
def add_default_fields_layout(force=False):
	quick_entry_layouts = {
		...
		"Donation-Quick Entry": {
			"doctype": "Donation",
			"layout": '[{"name":"basic_details_section","columns":[{"name":"column_basic1","fields":["company","donor_identity","contribution_type"]},{"name":"column_basic2","fields":["donation_cost_center","currency","select_donation_type"]}]},{"name":"payment_details_section","columns":[{"name":"column_payment_detail","fields":["payment_detail"]}]},{"name":"deduction_breakeven_section","columns":[{"name":"column_deduction_breakeven","fields":["deduction_breakeven"]}]}]',
		},
	}
	...
	sidebar_fields_layouts = {
		...
		"Donor-Side Panel": {
			"doctype": "Donor",
			"layout": '[{"label": "Details", "name": "details_section", "opened": true, "columns": [{"name": "column_details", "fields": ["donor_name", "donor_type", "email", "contact_no", "country", "status", "donor_owner"]}]}, {"label": "Personal Information", "name": "personal_section", "opened": true, "columns": [{"name": "column_personal", "fields": ["gender", "donor_identity", "donor_dob", "registration_date", "profession", "designation", "cnic", "identification_type"]}]}, {"label": "Organization Details", "name": "organization_section", "opened": true, "columns": [{"name": "column_organization", "fields": ["company_name", "company_owner_name", "company_contact_number", "company_email_address", "company_address", "company_website", "no_of_company_employees", "company_turnover"]}]}, {"label": "Care Of Details", "name": "care_of_section", "opened": true, "columns": [{"name": "column_care_of", "fields": ["foa", "co_name", "co_contact_no", "co_email", "co_address", "relationship_with_donor"]}]}, {"label": "Address", "name": "address_section", "opened": true, "columns": [{"name": "column_address", "fields": ["address_type", "address_line_1", "address_line_2", "citytown", "stateprovince", "district", "tehsil", "area"]}]}, {"label": "Accounting", "name": "accounting_section", "opened": true, "columns": [{"name": "column_accounting", "fields": ["default_currency", "default_account", "company"]}]}]',
		},
	}
